        ...
        <div class="category">
            ...
            <ul>
                ...
                <li class="<?= $a == "shipping" ? "active" : "" ?>">
                    <a href="index.php?c=customer&a=shipping" title="Địa chỉ giao hàng mặc định" target="_self">Địa chỉ giao hàng mặc định
                    </a>
                </li>
                <li class="<?= in_array($a, ['index', 'show']) ? "active" : "" ?>">
                    <a href="index.php?c=order" target="_self">Đơn hàng của tôi
                    </a>
                </li>
            </ul>
        </div>
